      ...
      <a-tab-pane key="answer" tab="自动答题">
        <a-space direction="vertical" :size="16" style="width: 100%">
          ...
          <a-card title="答题状态" size="small">
            <!-- 实时进度（仅显示进度数字） -->
            <div v-if="isAnswering && realtimeProgress.current > 0" style="margin-bottom: 16px;">
              <div style="padding: 12px; background: #f0f5ff; border-radius: 4px; border-left: 3px solid #1890ff;">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                  <span style="font-size: 14px; font-weight: 500; color: #1890ff;">
