...
(function (vue, pinia, rxjs, md5, ElementPlus) {
  ...
  function _sfc_render$1(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, _cache[0] || (_cache[0] = [
      vue.createElementVNode("p", null, "1、脚本功能完全免费，不存在付费情况，进入相应页面即可使用。", -1),
      vue.createElementVNode("p", null, '2、脚本没有开发自己到题库，而是接入了多个第三方题库，如需填写密钥，依次操作：[1] 点击标签页"答题" --> [2] 在文本框内填写 --> [3] 刷新', -1),
      vue.createElementVNode("p", { style: { "font-weight": "500" } }, "务必注意：", -1),
      vue.createElementVNode("p", null, "-- 脚本出现相关问题，请在脚本反馈区反馈，或者私信作者修复。", -1),
      vue.createElementVNode("p", null, "-- 题库密钥请确认能够搜索到题目再获取，题库均为网络收集的第三方题库，出现任何问题与脚本无关。如果你是程序员，可以自行接入自己的题库，这里不提供任何教程，也不会回复任何询问，请自行查看源代码修改即可，不会改的绕道。", -1)
    ]));
  }
